...
> **Stato:** la versione in corso è `v2.0.2` (la prima, `v2.0.0`, più le correzioni per il lint delle app in `v2.0.1` e il menu dei gruppi nella colonna chiusa del guscio in `v2.0.2`): le app la fissano nell'indirizzo del registry (vedi [`docs/INTEGRAZIONE.md`](docs/INTEGRAZIONE.md), passo 4). Le app già sul v1 hanno la loro guida: [`docs/GUIDA-MIGRAZIONE.md`](docs/GUIDA-MIGRAZIONE.md).
