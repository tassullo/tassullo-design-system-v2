...
```bash
npx shadcn@latest add tassullo/tassullo-design-system-v2/button#v2.0.3
```
...
> **Stato:** la versione in corso è `v2.0.3` (la prima, `v2.0.0`, più le correzioni per il lint delle app in `v2.0.1`, il menu dei gruppi nella colonna chiusa del guscio in `v2.0.2` e le etichette accessibili in italiano in `v2.0.3`): le app la fissano nell'indirizzo del registry (vedi [`docs/INTEGRAZIONE.md`](docs/INTEGRAZIONE.md), passo 4). Le app già sul v1 hanno la loro guida: [`docs/GUIDA-MIGRAZIONE.md`](docs/GUIDA-MIGRAZIONE.md).
