      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>Barra di navigazione</SheetTitle>
            <SheetDescription>Mostra la barra di navigazione su schermo stretto.</SheetDescription>
          </SheetHeader>
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      title="Apri o chiudi la barra di navigazione"
      className={cn(
