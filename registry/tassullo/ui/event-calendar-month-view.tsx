/**
 * event-calendar-month-view.tsx — ReUI (Keenthemes), adottato senza modifiche di forma.
...
import {
  ...
  wasRecentChipPress,
  wasRecentDrag,
} from "@/registry/tassullo/ui/event-calendar-dnd"
import {
  EVENT_CALENDAR_GHOST,
  EVENT_CALENDAR_SLOT_DRAFT,
  EventCalendarEvent,
} from "@/registry/tassullo/ui/event-calendar-event"
import {
  getDayKey,
  getRangeKey,
  resolveOffDay,
            ...
            >
              {viewConfig.renderDayHeader?.({
                ...
                <>
                  ...
                  <span className="hidden @max-xl:inline">
                    {format(
                      toZoned(day, settings.timeZone),
