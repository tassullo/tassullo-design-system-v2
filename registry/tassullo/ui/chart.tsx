  ...
  return (
    <div
      className={cn(
        ...
        // cambia qui (solo stringhe di classi). Senza, una legenda a cinque
        // voci dentro una card stretta resta su una riga sola e viene
        // **tagliata** dall'`overflow-hidden` della `Card`: sulla ciambella di
        // `Pagine/Dashboard` a finestra stretta si leggeva «alcestruzzi … Add».
