...
- **File**: *da decidere in sessione*. Se vince la (2): `registry/tassullo/blocks/data-grid.tsx` e le sue story. Se vince la (1): solo `docs/GUIDA-MIGRAZIONE.md` e una story che mostri la forma piatta. In ogni caso `CHECKLIST.md`, `WORKLOG.md`, e `docs/ANALISI-COPERTURA-APP.md` §8.3 con l'esito.
