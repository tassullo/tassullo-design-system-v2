...
```json
"registries": {
  "@tassullo": "https://raw.githubusercontent.com/tassullo/tassullo-design-system-v2/v2.0.2/public/r/{name}.json"
}
```
...
**La versione sta nell'indirizzo.** `v2.0.2` è l'etichetta della versione: fissata
...
`v2.0.2`); poi si reinstallano gli item installati per nome, il tema per primo:
...
dice GitHub: `github.com/tassullo/tassullo-design-system-v2/compare/v2.0.1...v2.0.2`.
...
- La versione del design system sta nell'indirizzo di `@tassullo` in
  `components.json`: un'etichetta git come `v2.0.2` (l'elenco è nella pagina
...
> (`tassullo/tassullo-design-system-v2`). **Versione installata: `v2.0.2`**,
